#ifndef _EPOLL_EVENT_DISPATCHER_H_
#define _EPOLL_EVENT_DISPATCHER_H_
...
class EpollEventDispatcher
{
  public:
    ...
    Status<void> AddEventHandler(int fd, int event_mask, Handler handler);
    Status<void> RemoveEventHandler(int fd);
